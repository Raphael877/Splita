...
//   // ✅ UPDATED: Fetches link dynamically, then uses robust copy logic
//   const handleCreateAndCopy = async () => {
//     setLoadingInvite(true);
//     try {
//       // 1. Generate the invite link from API
//       const res = await axios.get(`${BaseUrl}/groups/generate_invite/${id}`, {
//         headers: {
//           Authorization: `Bearer ${token}`,
//           "Content-Type": "application/json",
...
//         textarea.focus();
//         textarea.select();
//         textarea.setSelectionRange(0, 99999); // Critical for iOS
...
// //   const [loadingInvite] = useState(false);
