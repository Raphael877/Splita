  ...
  return (
    <AdminDashboard_content>
        <AdminDashboard_wrapper>
            <UserDashboardHeader />
            <div className='groupname'><h1>Obele Ajo</h1></div>
            <div className='round'>
                <div className='left'>
                    <p>Round <span>5/5</span></p>
                    <div className='ongoing'>
                        <p style={{color: '#3b82f6', fontSize: '0.8rem'}}>Completed</p>
                    </div>
                </div>
                <div className='right'>
            ...
            <div className='option'>
                <div className='option_wrap'>
                    <div className='inner_wrap'>
                        ...
                        <div className='cont' onClick={() => navigate('obele_contribution')}>
                            <p>Contributions</p>
                        </div>
                    </div>
                </div>
