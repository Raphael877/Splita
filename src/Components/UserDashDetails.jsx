...
//             <button
//               className="hello_btn2"
//               onClick={() => handleCopyLink("https://splita.ng/invite/123")}
//             >
//               Copy Invite Link
//             </button>
//           </div>
...
//                     <div className="right">
//                       <p>Remember to check your next contribution date</p>
//                       <p style={{ color: "#939393" }}>You can join multiple Ajos at once.</p>
//                     </div>
//                   </div>
//                   <div className="one">
//                     <div className="left2"><BsCash /></div>
//                     <div className="right">
//                       <p>Manual and automatic rotations can operate simultaneously</p>
//                       <p style={{ color: "#939393" }}>You can choose either method depending on what works best for your group in each cycle.</p>
//                     </div>
//                   </div>
//                   <div className="one">
//                     <div className="left3"><MdOutlinePersonAddAlt /></div>
//                     <div className="right">
//                       <p>Make your contribution early to avoid penalty fees</p>
...
//                     <div className="right">
//                       <p>New members are joining groups every day</p>
//                       <p style={{ color: "#939393" }}>Invite trusted friends to join your group and keep cycles running smoothly</p>
//                     </div>
//                   </div>
//                 </div>
//               </div>
...
// //         const successful = document.execCommand("copy");
// //         if (successful) {
// //            alert("Link copied successfully!"); // Replace with your Toast
// //         } else {
